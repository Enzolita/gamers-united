...
from .views import AddPost, Posts, PostDetail, DeletePost, EditPost, Add_Comment, Edit_Comment, Delete_Comment, GameCategory
...
urlpatterns = [
    ...
    path("category/<int:category_id>/", GameCategory.as_view(), name="category"),
